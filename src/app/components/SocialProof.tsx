...
const T_SP = {
  pt: {
    ...
    title2: 'dizem',
    subtitle: 'Avaliações reais de quem usa o Student Club',
    emptyTitle: 'Em breve, as primeiras avaliações',
    emptyText: 'Estamos começando! Assim que os primeiros alunos avaliarem o Student Club, os comentários aparecerão aqui em tempo real.',
    leaveYours: 'Deixe seu comentário',
    placeholder: 'Conte sua experiência usando o Student Club...',
    starsHint: 'Sua nota',
    submit: 'Publicar',
    sending: 'Enviando...',
    needLogin: 'Faça login para deixar seu comentário sobre o Student Club.',
  ...
  en: {
    ...
    title2: 'are saying',
    subtitle: 'Real reviews from Student Club users',
    emptyTitle: 'First reviews coming soon',
    emptyText: 'We are just getting started! As soon as the first students rate Student Club, their reviews will show up here in real time.',
    leaveYours: 'Leave your review',
    placeholder: 'Tell us about your experience with Student Club...',
    starsHint: 'Your rating',
    submit: 'Post',
    sending: 'Sending...',
    needLogin: 'Log in to leave a review about Student Club.',
  ...
  es: {
    ...
    title2: '',
    subtitle: 'Reseñas reales de quienes usan Student Club',
    emptyTitle: 'Próximamente, las primeras reseñas',
    emptyText: '¡Estamos empezando! Tan pronto como los primeros alumnos califiquen Student Club, sus comentarios aparecerán aquí en tiempo real.',
    leaveYours: 'Deja tu reseña',
    placeholder: 'Cuéntanos tu experiencia usando Student Club...',
    starsHint: 'Tu nota',
    submit: 'Publicar',
    sending: 'Enviando...',
    needLogin: 'Inicia sesión para dejar tu reseña sobre Student Club.',
