...
const TRANSLATIONS = {
  pt: {
    ...
    privacyCheckbox: 'Tenho 16+ anos e li/aceito a',
    privacyLink: 'Política de Privacidade',
    privacyCheckboxSuffix: 'do Student Club (LGPD, GDPR, Apple App Privacy, Google Data Safety). Estou ciente sobre o uso dos meus dados e regras de convivência.',
  ...
  en: {
    ...
    privacyCheckbox: 'I am 16+ and have read/agree to the',
    privacyLink: 'Privacy Policy',
    privacyCheckboxSuffix: 'of Student Club (LGPD, GDPR, Apple App Privacy, Google Data Safety). I acknowledge data usage and community guidelines.',
  ...
  es: {
    ...
    privacyCheckbox: 'Tengo 16+ años y leí/acepto la',
    privacyLink: 'Política de Privacidad',
    privacyCheckboxSuffix: 'de Student Club (LGPD, GDPR, Apple App Privacy, Google Data Safety). Acepto el uso de mis datos y las reglas de convivencia.',
