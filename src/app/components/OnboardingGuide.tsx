...
const STEPS = [
  {
    emoji: '👋',
    title: 'Bem-vindo ao Student Club!',
  ...
  },
  {
    ...
    desc: 'Empresas que fazem doações no Student Club transformam cada item gratuito em um lead presencial. Uma barbearia que oferece 10 cortes gratuitos garante 10 clientes na loja — e quando o cliente chega, a chance de contratar também barba, progressiva ou outros serviços é altíssima. Raramente alguém vai só para o corte! Isso vale para qualquer negócio: restaurante, academia, clínica, loja. Cada doação é uma visita real, um cliente real, uma venda real.',
    image: null,
