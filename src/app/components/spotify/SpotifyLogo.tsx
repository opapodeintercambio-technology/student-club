// Logo oficial do Spotify (SVG) — branding obrigatório por Developer ToS.
// Fonte: https://developer.spotify.com/documentation/design#using-our-logo
//
// Variantes:
// - default (verde): usar em fundos brancos / claros
// - mono (branco): usar em fundos coloridos / escuros (ex: bubble do chat)
...
export function SpotifyLogo({ className = 'w-4 h-4', mono = false }: Props) {
  const fill = mono ? '#ffffff' : '#1db954';
  return (
    <svg
      viewBox="0 0 168 168"
      className={className}
